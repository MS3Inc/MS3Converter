...
const resource_section_to_string_1 = require("./resource-section-to-string");
class ApiBlueprintToString {
    ...
    stringify() {
        ...
        if (this.source.resourceGroup)
            this.result += resource_section_to_string_1.default.create(this.source.resourceGroup, {}).stringify();
        return this.result;
    }
